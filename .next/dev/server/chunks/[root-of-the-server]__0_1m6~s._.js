...
function parseLatestTimetableFromUploads() {
    ...
    const workbook = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readFile"](filePath);
    const mappingSheet = workbook.Sheets['Mappings'];
    if (!mappingSheet) {
        throw new Error('Mappings sheet is missing in the workbook.');
    }
    const mappingRows = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["utils"].sheet_to_json(mappingSheet, {
        header: 1,
        defval: ''
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_1m6~s._.js.map